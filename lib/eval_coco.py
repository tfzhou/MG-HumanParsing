...
ANNOTATIONS_VAL = 'data/coco/annotations/person_keypoints_val2017.json'
DET_ANNOTATIONS_VAL = 'data/coco/annotations/instances_val2017.json'
IMAGE_DIR_VAL = 'data/coco/images/val2017/'
ANNOTATIONS_TESTDEV = 'data/coco/annotations/image_info_test-dev2017.json'
ANNOTATIONS_TEST = 'data/coco/annotations/image_info_test2017.json'
IMAGE_DIR_TEST = 'data/coco/images/test2017/'
